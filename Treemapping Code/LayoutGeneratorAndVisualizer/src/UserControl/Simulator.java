...
//            updateTreeMap(nextTreeMap);
    ...
    private void runExperiments() {
        ...
        //TODO Incremental change the facilitator. Must be the last one at the moment. fix this
...
//                modelController.newStatisticsFile(new File("experiment/" + generator.getClass().getName() + ";" + generator.getParamaterDescription()));
                ...
                String faceOutputString = "" + outputFolder.getAbsoluteFile() + "\\4Moves" + generator.getClass().getSimpleName() + "\\" + name;
                ...
                try {
                    ...
                    if (generateBaseLines) {
                        File baseLineOutputFolder = new File("" + outputFolder.getAbsoluteFile() + "\\4Moves" + generator.getClass().getSimpleName() + "\\baseLine" + name
                        );
