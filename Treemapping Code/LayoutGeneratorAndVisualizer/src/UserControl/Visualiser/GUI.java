...
public final class GUI extends javax.swing.JFrame {
    ...
    public GUI(Visualiser visualiser) {
        ...
        String[] facilitators = new String[]{"Coffee3Hierarchy", "Coffee2Hierarchy", "Random", "SeqRandom", "RandomLogNormal", "SeqRandomLogNormal", "Poisson", "spacemacs", "fsharp", "hiv", "standard", "hystrix", "gen1", "PopularNames", "PopularNames2", "KijkCijfers10"};
        dataFacilitatorSelector.setModel(new DefaultComboBoxModel(facilitators));
        dataFacilitatorSelector.setSelectedIndex(12);
        setDataFacilitator("gen1");
    ...
    public void setDataFacilitator(String identifier) {
        ...
        switch (identifier) {
            ...
            case "spacemacs":
                ...
                break;
            case "fsharp":
                df = new DataFileManagerFast("D:\\Development\\TreemapStability\\dataset-temp\\fsharp.data");
                break;
            case "hiv":
                df = new DataFileManagerFast("D:\\Development\\TreemapStability\\datasetsCorrected\\hiv.data");
                break;
            case "standard":
                df = new DataFileManagerFast("D:\\Development\\TreemapStability\\dataSetsCorrected\\standard.data");
                break;
            case "hystrix":
                df = new DataFileManagerFast("D:\\Development\\TreemapStability\\dataSetsCorrected\\hystrix.data");
                break;
            case "gen1":
                df = new DataFileManagerFast("D:\\Development\\TreemapStability\\Cumulative4Year90HoursRating.csv");
                break;
            case "PopularNames":
...
//        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        TreeMap tm = tmr.readTreeMap(new File("D:\\Development\\TreemapStability\\output-temp\\MooreTreeMap\\fsharp.data\\t37.rect"));
